...
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (isInEditMode()) {
            mColors = new int[4];
            mColors[0] = getResources().getColor(R.color.colorPrimary);
            mColors[1] = getResources().getColor(R.color.colorPrimary);
            mColors[2] = getResources().getColor(R.color.colorPrimary);
            mColors[3] = getResources().getColor(R.color.colorPrimary);
        } else {
