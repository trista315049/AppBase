...
import com.oit.appbase.base.LimoApplication;
...
public class OkHttp3Utils {
    ...
    //设置缓存目录
    private static File cacheDirectory = new File(LimoApplication.getContent().getExternalCacheDir(), "MyCache");
...
//                    .addNetworkInterceptor(new CookiesInterceptor(MyApplication.getInstance().getApplicationContext()))
    ...
    private static final Interceptor TestInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!isNetworkReachable(LimoApplication.getContent())) {
